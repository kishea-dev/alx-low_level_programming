...
/**
 * add_arrays - add 2 arrays of integers
...
/**
 * multiply - multiplies two munbers
 * @num1: factor # 1 (ithe smaller number)
 * @len_1: length of factor 1
 * @num2: factor # 2 (the larger number)
...
/**
 * main - multiply 2 inputs numbers
 * of large lengths
 * and print result or print Error
